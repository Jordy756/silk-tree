...
import { useMedicalAppointmentForm } from "src/modules/medicalAppointment/hooks/useMedicalAppointmentForm";
import { getMedicalAppointmentFormValidation } from "src/modules/medicalAppointment/utils/handleAppointmentForm";
  ...
  return (
    <Form handleSubmit={handleSubmit} onSubmit={onSubmit}>
      ...
      <InputBox labelText="Especialidad" error={errors.specialty}>
        <select {...register("specialty", getMedicalAppointmentFormValidation("specialty"))} disabled={isNonEditable}>
